...
def load_student_data():
    ...
    df['availability'] = df.apply(lambda row: [f"{day_name}: {day}" for day_name, day in zip(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'], row[['monday_availability', 'tuesday_availability', 'wednesday_availability', 'thursday_availability', 'friday_availability']]) if pd.notna(day) and day != 'Not Available'], axis=1)
    df['status'] = "Pending"
