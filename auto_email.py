...
def email_student(student, matched_tutor):
    ...
    message['Body'] = f'Dear {student.name}, \n Congratulations! You have succesfully been matched with {matched_tutor.name} for peer tutoring in these classes: {student.classes}. {matched_tutor.name} is available to meet with you on: {student.availability}.'
